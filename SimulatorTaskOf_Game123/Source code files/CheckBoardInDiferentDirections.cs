...
class CheckBoardInDiferentDirections
{
    private readonly char[,] board = null;

    public CheckBoardInDiferentDirections(char[,] board)
    {
        this.board = board;
    }
    ...
    public Point[] Search2Plus1PositionsHorizontal(Point[] position, char character, int limitOfSearching)
    {
    ...
    public Point[] Search2Plus1PositionsVertical(Point[] position, char character, int limitOfSearching)
    {
        Point[] searchedPositions = null;
    ...
    public Point[] Search2Plus1PositionsLeftDiagonal(Point[] listOfPositionsOfAppearancedElements, char character, int limitOfSearching)
    {
        Point[] searchedPositions = null;
    ...
    public Point[] Search2Plus1PositionsRightDiagonal(Point[] position, char character, int limitOfSearching)
    {
        Point[] searchedPositions = null;
